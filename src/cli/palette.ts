...
export const COMMANDS: readonly Command[] = [
  ...
  { name: 'history', hint: 'recent conversation memory used for follow-ups', alias: ['memory', 'transcript'] },
  { name: 'folder', hint: 'where read/write/edit tool calls are confined', alias: ['dir', 'cwd', 'sandbox'] },
  { name: 'permissions', hint: 'readonly · ask · auto · yolo — what tools the model has', alias: ['perms', 'yolo'] },
